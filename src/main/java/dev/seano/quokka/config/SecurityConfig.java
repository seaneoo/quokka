...
public class SecurityConfig {
    ...
    public PasswordEncoder passwordEncoder() {
        return new Argon2PasswordEncoder(applicationProperties.getArgon2()
                .getSaltLength(), applicationProperties.getArgon2()
                .getHashLength(), applicationProperties.getArgon2()
